...
st.markdown(
    "Upload a MusicXML (`.xml`, `.mxl`, or `.musicxml`) file and get predicted fingerings "
...
if uploaded is not None:
    ...
    with st.spinner("Predicting fingerings..."):
        ...
        st.write(f"Model expects {model.n_features_in_} features, app is sending {X.shape[1]} features")
